...
TEAM_METADATA = {
    ...
    'Delhi Capitals': {'short_name': 'DC', 'primary_color': '#0078BC', 'secondary_color': '#E41B17', 'captain': 'KL Rahul', 'coach': 'Hemang Badani', 'titles': 0, 'title_years': [], 'home_venue': 'Arun Jaitley Stadium, Delhi'},
    'Punjab Kings': {'short_name': 'PBKS', 'primary_color': '#DD1F2D', 'secondary_color': '#A7A9AC', 'captain': 'Shreyas Iyer', 'coach': 'Ricky Ponting', 'titles': 0, 'title_years': [], 'home_venue': 'Punjab Cricket Association IS Bindra Stadium, Mohali'},
    'Lucknow Super Giants': {'short_name': 'LSG', 'primary_color': '#3067AA', 'secondary_color': '#FF7722', 'captain': 'Rishabh Pant', 'coach': 'Justin Langer', 'titles': 0, 'title_years': [], 'home_venue': 'Bharat Ratna Shri Atal Bihari Vajpayee Ekana Cricket Stadium, Lucknow'}
}
...
KNOWN_PLAYERS_META = {
    ...
    'S Dhawan': {'full_name': 'Shikhar Dhawan', 'display_name': 'Shikhar Dhawan', 'country': 'India', 'dob': '05-Dec-1985', 'role': 'Batter', 'batting_style': 'Left-hand bat', 'bowling_style': 'Right-arm offbreak', 'current_team': 'Punjab Kings (Former)', 'jersey_number': 42, 'status': 'Retired', 'career_span': '2008 - 2024', 'aliases': ['Gabbar', 'Shikhi', 'Dhawan'], 'avatar': ''},
    'DA Warner': {'full_name': 'David Warner', 'display_name': 'David Warner', 'country': 'Australia', 'dob': '27-Oct-1986', 'role': 'Batter', 'batting_style': 'Left-hand bat', 'bowling_style': 'Right-arm legbreak', 'current_team': 'Delhi Capitals (Former)', 'jersey_number': 31, 'status': 'Retired', 'career_span': '2009 - 2024', 'aliases': ['The Bull', 'Warner', 'Davey'], 'avatar': ''},
    ...
    'KL Rahul': {'full_name': 'K L Rahul', 'display_name': 'KL Rahul', 'country': 'India', 'dob': '18-Apr-1992', 'role': 'WK-Batter', 'batting_style': 'Right-hand bat', 'bowling_style': 'Right-arm medium', 'current_team': 'Delhi Capitals', 'jersey_number': 1, 'status': 'Active', 'career_span': '2013 - Present', 'aliases': ['KL', 'KLR', 'Rahul'], 'avatar': ''},
    ...
    'YS Chahal': {'full_name': 'Yuzvendra Chahal', 'display_name': 'Yuzvendra Chahal', 'country': 'India', 'dob': '23-Jul-1990', 'role': 'Bowler', 'batting_style': 'Right-hand bat', 'bowling_style': 'Legbreak googly', 'current_team': 'Punjab Kings', 'jersey_number': 3, 'status': 'Active', 'career_span': '2013 - Present', 'aliases': ['Yuzi', 'Chahal', 'Chessmaster'], 'avatar': ''},
    'B Kumar': {'full_name': 'Bhuvneshwar Kumar', 'display_name': 'Bhuvneshwar Kumar', 'country': 'India', 'dob': '05-Feb-1990', 'role': 'Bowler', 'batting_style': 'Right-hand bat', 'bowling_style': 'Right-arm medium-fast', 'current_team': 'Royal Challengers Bengaluru', 'jersey_number': 15, 'status': 'Active', 'career_span': '2011 - Present', 'aliases': ['Bhuvi', 'Swing King'], 'avatar': ''},
    ...
    'RR Pant': {'full_name': 'Rishabh Pant', 'display_name': 'Rishabh Pant', 'country': 'India', 'dob': '04-Oct-1997', 'role': 'WK-Batter', 'batting_style': 'Left-hand bat', 'bowling_style': 'Right-arm medium', 'current_team': 'Lucknow Super Giants', 'jersey_number': 17, 'status': 'Active', 'career_span': '2016 - Present', 'aliases': ['Spidey', 'Pant', 'RP17'], 'avatar': ''},
